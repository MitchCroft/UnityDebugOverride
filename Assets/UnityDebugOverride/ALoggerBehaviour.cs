/******************************************************************************
*                                                                             *
*                            5/26/2020 1:19:14 PM                             *
*                                                                             *
*  "Chuck Norris compresses his files by doing a flying round house kick to   *
*                              the hard drive."                               *
*                                                                             *
******************************************************************************/
...
namespace UnityDebugOverride {
    /// <summary>
    /// Provide a base level for logger MonoBehaviours to base their functionality off of
    /// </summary>
    /// <remarks>
    /// This class object is a <see cref="MonoBehaviour"/> port of the <see cref="Logger"/> object
    /// for use with the UnityDebugOverride system. This is intended as a quick start object
    /// where people can customise the logging behaviour quickly without large amounts of copy/paste 
    /// boilerplate. All messages received via the ILogger interface are forwarded to two functions
    /// (ProcessLog and ProcessException) but can be overridden individually if required
    /// 
    ...
    /// </remarks>
    public abstract class ALoggerBehaviour : MonoBehaviour, ILogger {
        /*----------Variables----------*/
        //VISIBLE
